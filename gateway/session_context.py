...
_EXTERNAL_EVENTS_TOKEN_FILE: ContextVar = ContextVar(
    "HERMES_EXTERNAL_EVENTS_TOKEN_FILE", default=_UNSET
)
...
_VAR_MAP = {
    ...
    "HERMES_EXTERNAL_EVENTS_TOKEN_FILE": _EXTERNAL_EVENTS_TOKEN_FILE,
...
def set_session_vars(
    ...
    ui_session_id: str = "",
    external_events_token_file: str = "",
) -> list:
    ...
    tokens = [
        ...
        _EXTERNAL_EVENTS_TOKEN_FILE.set(external_events_token_file),
